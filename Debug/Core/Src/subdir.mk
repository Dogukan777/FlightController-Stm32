...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/SH1106.cyclo ./Core/Src/SH1106.d ./Core/Src/SH1106.o ./Core/Src/SH1106.su ./Core/Src/bldcMotor.cyclo ./Core/Src/bldcMotor.d ./Core/Src/bldcMotor.o ./Core/Src/bldcMotor.su ./Core/Src/controlPPM.cyclo ./Core/Src/controlPPM.d ./Core/Src/controlPPM.o ./Core/Src/controlPPM.su ./Core/Src/flightController.cyclo ./Core/Src/flightController.d ./Core/Src/flightController.o ./Core/Src/flightController.su ./Core/Src/fonts.cyclo ./Core/Src/fonts.d ./Core/Src/fonts.o ./Core/Src/fonts.su ./Core/Src/freertos.cyclo ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/gpsSystem.cyclo ./Core/Src/gpsSystem.d ./Core/Src/gpsSystem.o ./Core/Src/gpsSystem.su ./Core/Src/gyroscope.cyclo ./Core/Src/gyroscope.d ./Core/Src/gyroscope.o ./Core/Src/gyroscope.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/serialManager.cyclo ./Core/Src/serialManager.d ./Core/Src/serialManager.o ./Core/Src/serialManager.su ./Core/Src/settings.cyclo ./Core/Src/settings.d ./Core/Src/settings.o ./Core/Src/settings.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/storage.cyclo ./Core/Src/storage.d ./Core/Src/storage.o ./Core/Src/storage.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/wpManager.cyclo ./Core/Src/wpManager.d ./Core/Src/wpManager.o ./Core/Src/wpManager.su
